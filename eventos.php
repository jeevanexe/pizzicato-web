...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── HERO responsive ── */
        @media (max-width: 768px) { .hero-content { padding: 3rem 1.5rem; } .hero-inner { max-width: 100%; } .hero-meta { gap: 1rem; } }
        @media (max-width: 480px) { .hero-content { padding: 2.5rem 1.25rem; } }

        /* ── Section responsive ── */
        @media (max-width: 768px) { .eventos-section { padding: 3rem 1.5rem; } .section-header { flex-direction: column; gap: 0.5rem; } }
        @media (max-width: 480px) { .eventos-section { padding: 2.5rem 1.25rem; } .cards-grid { grid-template-columns: 1fr; } }

        /* ── CTA responsive ── */
        @media (max-width: 768px) { .cta-section { padding: 4rem 1.5rem; } }
        @media (max-width: 480px) { .cta-section { padding: 3rem 1.25rem; } }
...
<div class="mobile-nav" id="mobileNav" role="dialog" aria-modal="true" aria-label="Menú de navegación">
    <div class="mobile-nav-panel">
        ...
        <a href="eventos.php" class="active">Eventos</a>
